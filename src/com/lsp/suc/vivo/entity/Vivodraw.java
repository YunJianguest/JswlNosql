 ...
 *
 */
public class Vivodraw extends ReflectionDBObject{
	/**
	 * 标题
	 */															
	 ...
	 */
	private int yz;
	private List<VivoReward> reward;
	...
	public List<VivoReward> getReward() {
		return reward;
	}
	public void setReward(List<VivoReward> reward) {
		this.reward = reward;
	}
	...
	public List<Card> getLsCards() {
		return lsCards;
	}
	public void setLsCards(List<Card> lsCards) {
