...
public class PubConstants
{
  ...
  public static String SUC_VIVO_LUCKYDROW="suc_vivo_luckydraw";//抽奖 
  public static String SUC_VIVO_REWARDRECORD="suc_vivo_rewardrecord";//中奖统计
  public static String SUC_VIVO_CARD="suc_vivo_card";//卡片
  public static String SUC_VIVO_CARDREWARD="suc_vivo_cardreward";//卡片记录
  public static String SUC_VIVO_DJCODE="suc_vivo_djcode";//串码
  public static String SUC_VIVO_EMPLOYEES="suc_vivo_employees";//员工
  public static String SUC_VIVO_RANKING="suc_vivo_ranking";//排行榜
