            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" id="custinfoForm" method="post"
                          action="${contextPath}/suc/vivo/vivodraw!save.action?fypage=${fypage}">
                                         ...
                                         <div class="col-2 pr-10">
                                            ...
                                            <div class="line-bottom line-right line-left1 hang40 overflow-hidden">
                                                <select id="zjl" name="zjl" class="hang40 width-10"
                                                        data-placeholder="请选择">
                                                    <option value="">选请择</option>
                                                    <option value="500">最高（推荐奖品总数量500内）</option>
                                                    <option value="1000">特高（推荐奖品总数量1000内）</option>
                                                    <option value="2000">极高（推荐奖品总数量2000内）</option>
                                                    <option value="3000">高（推荐奖品总数量3000内）</option>
                                                    <option value="5000">普通（推荐奖品总数量5000内）</option>
                                                    <option value="8000">低（推荐奖品总数量8000内）</option>
                                                    <option value="10000">很低（推荐奖品总数量10000内）</option>
                                                    <option value="13000">极低（推荐奖品总数量13000内）</option>
                                                    <option value="15000">非常低（推荐奖品总数量15000内）</option>
                                                    <option value="18000">真低（推荐奖品总数量18000内）</option>
                                                    <option value="20000">最低（推荐奖品总数量20000内）</option>
